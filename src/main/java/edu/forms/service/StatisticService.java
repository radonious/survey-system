...
import edu.forms.repository.StatisticRepository;
import edu.forms.dto.statistic.*;
        ...
        List<QuestionStatisticDTO> allQuestionStatistics = allQuestions.stream()
                .map(question -> {
                    ...
                    return switch (question.getType()) {
                        case QuestionType.TEXT -> getTextQuestionStatistic(question, questionAnswers);
                        case QuestionType.NUMERIC -> getNumericQuestionStatistic(question, questionAnswers);
                        ...
                        case QuestionType.RATING -> getRatingStatistic(question, questionAnswers, questionOptions);
                    };
                })
